...
const Profile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get('https://erp-sxpm.onrender.com/api/admin/getProfile', {
        headers: {
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-gray-900">{data.loginid}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-medium text-gray-900">{data.phoneNumber}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
